 ...
 */
abstract class LazyEventManager extends EventManager
{
    /**
     ...
     */
    abstract protected function lazyLoadListener($id);
        ...
        if (isset($this->listeners[$eventName])) {
            ...
            foreach ($this->listeners[$eventName] as $hash => $listener) {
                if (!$initialized && is_string($listener)) {
                    $this->listeners[$eventName][$hash] = $listener = $this->lazyLoadListener($listener);
                }
